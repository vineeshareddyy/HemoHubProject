"""
Django settings for HemoHubProject project.
...
SECRET_KEY = 'django-insecure-$ystqw()ffn@v*4cpkg+%&^i*m3%ft7+go5a9&49%vtm&-cu_c'
...
CELERY_TIMEZONE = 'UTC'
# settings.py
from celery.schedules import crontab, schedule # or any other broker
CELERY_BEAT_SCHEDULE = {
    'check-expiring-blood-products-every-day': {
        'task': 'HemoHubApp.tasks.check_expiring_blood_products',
        'schedule': schedule(5.0),  # every day at midnight
    },
}
